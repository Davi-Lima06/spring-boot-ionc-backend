...
import com.davi.cursomc.domain.Estado;
import com.davi.cursomc.domain.ItemPedido;
import com.davi.cursomc.domain.Pagamento;
import com.davi.cursomc.domain.PagamentoComBoleto;
import com.davi.cursomc.domain.PagamentoComCartao;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTefefones().addAll(Arrays.asList("27363323","93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto303", "Jardim", "39220834", cli1, c1);
